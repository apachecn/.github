...
1.  [ApacheCN 数据科学译文集⭐](https://github.com/apachecn/apachecn-ds-zh?utm_source=home)
    ...
    +   [NumPy 秘籍中文第二版](https://github.com/apachecn/apachecn-ds-zh/blob/master/docs/numpy-cookbook-2e?utm_source=home)
    +   [NumPy 初学者指南中文第三版](https://github.com/apachecn/apachecn-ds-zh/blob/master/docs/numpy-beginners-guide-3e?utm_source=home)
    +   [NumPy 基础知识](https://github.com/apachecn/apachecn-ds-zh/blob/master/docs/numpy-essentials?utm_source=home)
    +   [精通 NumPy 数值分析](https://github.com/apachecn/apachecn-ds-zh/blob/master/docs/master-num-comp-numpy?utm_source=home)
    +   [Pandas 秘籍](https://github.com/apachecn/apachecn-ds-zh/blob/master/docs/pandas-cookbook?utm_source=home)
    +   [Pandas 学习手册中文第二版](https://github.com/apachecn/apachecn-ds-zh/blob/master/docs/learning-pandas-2e?utm_source=home)
    +   [精通 Pandas](https://github.com/apachecn/apachecn-ds-zh/blob/master/docs/master-pandas?utm_source=home)
    +   [NumPy 和 Pandas 数据分析实用指南](https://github.com/apachecn/apachecn-ds-zh/blob/master/docs/handson-data-analysis-numpy-pandas?utm_source=home)
    +   [精通 Pandas 探索性分析](https://github.com/apachecn/apachecn-ds-zh/blob/master/docs/master-exp-analysis-pandas?utm_source=home)
    +   [Sklearn 秘籍](https://github.com/apachecn/apachecn-ds-zh/blob/master/docs/sklearn-cookbook?utm_source=home)
    +   [Sklearn 学习指南](https://github.com/apachecn/apachecn-ds-zh/blob/master/docs/learning-sklearn?utm_source=home)
...
1.  [ApacheCN TensorFlow 译文集⭐](https://github.com/apachecn/apachecn-tf-zh?utm_source=home)
    ...
    +   [TensorFlow 深度学习中文第二版](https://github.com/apachecn/apachecn-tf-zh/blob/master/docs/dl-tf-2e-zh?utm_source=home)
    +   [TensorFlow 深度学习实战指南中文版](https://github.com/apachecn/apachecn-tf-zh/blob/master/docs/hands-on-dl-tf-zh?utm_source=home)
    +   [精通 TensorFlow 1.x](https://github.com/apachecn/apachecn-tf-zh/blob/master/docs/mastering-tf-1x-zh?utm_source=home)
    +   [TensorFlow 机器学习秘籍中文第二版](https://github.com/apachecn/apachecn-tf-zh/blob/master/docs/tf-ml-cookbook-2e-zh?utm_source=home)
    +   [与 TensorFlow 的初次接触](https://github.com/apachecn/apachecn-tf-zh/blob/master/docs/first_contact_with_tensorFlow?utm_source=home)
    +   [TensorFlow 学习指南](https://github.com/apachecn/apachecn-tf-zh/blob/master/docs/learning-tf-zh?utm_source=home)
    +   [TensorFlow Rager 教程](https://github.com/apachecn/apachecn-tf-zh/blob/master/docs/tf-eager-tut?utm_source=home)
...
1.  [ApacheCN 网络安全译文集⭐](https://github.com/apachecn/apachecn-sec-zh?utm_source=home)
    +   [Kali Linux 秘籍 中文版](https://github.com/apachecn/apachecn-sec-zh/blob/master/docs/kali-linux-cookbook-zh?utm_source=home)
    +   [Kali Linux 网络扫描秘籍 中文版](https://github.com/apachecn/apachecn-sec-zh/blob/master/docs/kali-linux-network-scanning-cookbook-zh?utm_source=home)
    +   [Kali Linux Web 渗透测试秘籍 中文版](https://github.com/apachecn/apachecn-sec-zh/blob/master/docs/kali-linux-web-pentest-cookbook-zh?utm_source=home)
    +   [Kali Linux 无线渗透测试入门指南](https://github.com/apachecn/apachecn-sec-zh/blob/master/docs/kali-linux-wireless-pentest-zh?utm_source=home)
    +   [Android 渗透测试学习手册 中文版](https://github.com/apachecn/apachecn-sec-zh/blob/master/docs/lpad-zh?utm_source=home)
    +   [SploitFun Linux x86 Exploit 开发系列教程](https://github.com/apachecn/apachecn-sec-zh/blob/master/docs/sploitfun-linux-x86-exp-tut-zh?utm_source=home)
    +   [浅入浅出 Android 安全中文版](https://github.com/apachecn/apachecn-sec-zh/blob/master/docs/asani-zh?utm_source=home)
    +   [格式化字符串漏洞利用](https://github.com/apachecn/apachecn-sec-zh/blob/master/docs/exp-fmt-str-vul-zh?utm_source=home)
